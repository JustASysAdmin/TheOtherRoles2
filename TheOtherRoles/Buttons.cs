...
namespace TheOtherRoles
{
    ...
    static class HudManagerStartPatch
    {
        ...
        public static void setCustomButtonCooldowns() {
            ...
            trackerTrackPlayerButton.MaxTimer = Tracker.TrackerCooldown;
        ...
        public static void createButtonsPostfix(HudManager __instance) {
            ...
            blackmailerButton = new CustomButton(
               ...
               __instance,
               KeyCode.F,
               buttonText: ModTranslation.getString("blackmail")
           );
            ...
            minerMineButton = new CustomButton(
                ...
                {
                    /* Can Use */
                    if (minerMineButtonText != null) minerMineButtonText.text = $"{Miner.mineNumber}";
                    ...
                    return hits.Count == 0 && CachedPlayer.LocalPlayer.PlayerControl.CanMove && Miner.mineNumber > 0;
                },
                () =>
                {
                    /* On Meeting End */
                ...
                __instance,
                KeyCode.F,
                buttonText: Helpers.transl("mine")
            );
            ...
            veteranAlertButton = new CustomButton(
                ...
                () => {
                    ...
                    return CachedPlayer.LocalPlayer.PlayerControl.CanMove && Veteran.remainingAlerts > 0 && MrFreeze.mrFreezeTimer <= 0;
                },
                () => {
            ...
            swooperKillButton = new CustomButton(
                () => {
                    if (Swooper.currentTarget == Veteran.veteran && Veteran.alertActive)
                    {
                        Helpers.checkMurderAttemptAndKill(Swooper.swooper, Swooper.swooper);
                        return;
                    }
                ...
                () => { return Swooper.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { swooperKillButton.Timer = swooperKillButton.MaxTimer; },
            ...
            sheriffKillButton = new CustomButton(
                ...
                () => { return Sheriff.currentTarget && MrFreeze.mrFreezeTimer <= 0 && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
                () => { sheriffKillButton.Timer = sheriffKillButton.MaxTimer;},
                __instance.KillButton.graphic.sprite,
                CustomButton.ButtonPositions.upperRowRight,
                __instance,
            ...
            jackalSidekickButton = new CustomButton(
                ...
                () => { return Jackal.canCreateSidekick && Jackal.currentTarget != null && CachedPlayer.LocalPlayer.PlayerControl.CanMove && MrFreeze.mrFreezeTimer <= 0; },
            ...
            jackalKillButton = new CustomButton(
                ...
                () => { return Jackal.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove && MrFreeze.mrFreezeTimer <= 0; },
                () => { jackalKillButton.Timer = jackalKillButton.MaxTimer;},
                __instance.KillButton.graphic.sprite,
                CustomButton.ButtonPositions.upperRowRight,
                __instance,
                KeyCode.Q,
                buttonText: Helpers.transl("killButtonText")
            );
            ...
            sidekickKillButton = new CustomButton(
                ...
                () => { return Sidekick.currentTarget && CachedPlayer.LocalPlayer.PlayerControl.CanMove && MrFreeze.mrFreezeTimer <= 0; },
                () => { sidekickKillButton.Timer = sidekickKillButton.MaxTimer;},
                __instance.KillButton.graphic.sprite,
                CustomButton.ButtonPositions.upperRowRight,
                __instance,
            ...
            arsonistButton = new CustomButton(
                ...
                () => {
                    ...
                    return CachedPlayer.LocalPlayer.PlayerControl.CanMove && MrFreeze.mrFreezeTimer <= 0 && (dousedEveryoneAlive || Arsonist.currentTarget != null);
                },
                () => {
            ...
            pursuerButton = new CustomButton(
                ...
                () => {
                    ...
                    return Pursuer.blanksNumber > Pursuer.blanks && MrFreeze.mrFreezeTimer <= 0 && CachedPlayer.LocalPlayer.PlayerControl.CanMove && Pursuer.target != null;
                },
                () => { pursuerButton.Timer = pursuerButton.MaxTimer; },
               ...
               () => {
                   ...
                   foreach (PlayerTask task in CachedPlayer.LocalPlayer.PlayerControl.myTasks.GetFastEnumerator())
                       if (task.TaskType == TaskTypes.FixLights || task.TaskType == TaskTypes.RestoreOxy || task.TaskType == TaskTypes.ResetReactor || task.TaskType == TaskTypes.ResetSeismic || task.TaskType == TaskTypes.FixComms || task.TaskType == TaskTypes.StopCharles
                           || SubmergedCompatibility.IsSubmerged && task.TaskType == SubmergedCompatibility.RetrieveOxygenMask)
                           sabotageActive = true;
                   return !sabotageActive && MrFreeze.mrFreezeTimer <= 0 && CachedPlayer.LocalPlayer.PlayerControl.CanMove && (Mayor.remoteMeetingsLeft > 0);
               },
            ...
            thiefKillButton = new CustomButton(
               ...
               () => { return Thief.currentTarget != null && MrFreeze.mrFreezeTimer <= 0 && CachedPlayer.LocalPlayer.PlayerControl.CanMove; },
               () => { thiefKillButton.Timer = thiefKillButton.MaxTimer; },
               __instance.KillButton.graphic.sprite,
               CustomButton.ButtonPositions.upperRowRight,
               __instance,
            ...
            mrFreezeButton = new CustomButton(
                ...
                MrFreeze.duration,
                () => { mrFreezeButton.Timer = mrFreezeButton.MaxTimer; },
                buttonText: Helpers.transl("freeze")
            );
