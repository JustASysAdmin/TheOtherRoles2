...
namespace TheOtherRoles
{
        ...
        public static void createButtonsPostfix(HudManager __instance) {
            ...
            shifterShiftButton = new CustomButton(
                () => {
                    ...
                    if (MapOptionsTor.enableSoundEffects) SoundManager.Instance.PlaySound(CustomMain.customZips.shifterShift, false, 0.8f);
                },
            ...
            trackerTrackPlayerButton = new CustomButton(
                ...
                () => { 
                    if (!Tracker.usedTracker)
                        showTargetNameOnButton(Tracker.currentTarget, trackerTrackPlayerButton, "TRACK");
            ...
            privateInvestigatorWatchButton = new CustomButton(
                ...
                () => { 
                    if (PrivateInvestigator.watching == null)
                        showTargetNameOnButton(BodyGuard.currentTarget, bodyGuardGuardButton, "Watch");
    ...
    buttonText:"USE"
            ...
            jackalSidekickButton = new CustomButton(
                ...
                () => { 
                    showTargetNameOnButton(Jackal.currentTarget, jackalSidekickButton, "SIDEKICK"); // Show now text since the button already says sidekick
            ...
            securityGuardButton = new CustomButton(
                () => {
                    if (SecurityGuard.ventTarget != null) { // Seal vent
                        ...
                        securityGuardButton.buttonText = "SEAL";
            ...
            arsonistButton = new CustomButton(
                () => {
                    ...
                    if (dousedEveryoneAlive)
                    {
                        ...
                        arsonistButton.buttonText = "IGNITE";
                    }
            ...
            ninjaButton = new CustomButton(
                () => {
                    ...
                    if (Ninja.ninjaMarked != null) {
                        ...
                        if (attempt == MurderAttemptResult.PerformKill || attempt == MurderAttemptResult.ReverseKill) {
                            ...
                            ninjaButton.buttonText = "ASSASSINAT";
                        }
                ...
                () => {  // CouldUse
                    showTargetNameOnButton(Ninja.currentTarget, ninjaButton, "MARK");
           ...
           if (Blackmailer.blackmailed != null) text = Blackmailer.blackmailed.Data.PlayerName;
            ...
            propHuntFindButton = new CustomButton(
                ...
                5f,
                () => {
                    if (MapOptionsTor.enableSoundEffects) SoundManager.Instance.StopSound(CustomMain.customZips.engineerRepair);
