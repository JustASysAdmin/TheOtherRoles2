    ...
    public class OnGameEndPatch {
        ...
        public static void Postfix(AmongUsClient __instance, [HarmonyArgument(0)]ref EndGameResult endGameResult) {
            ...
            // Prosecutor win
                ...
                EndGameResult.CachedWinners = new Il2CppSystem.Collections.Generic.List<CachedPlayerData>();
                CachedPlayerData wpd = new CachedPlayerData(Prosecutor.prosecutor.Data);
                EndGameResult.CachedWinners.Add(wpd);
                ...
                if (!Lovers.existingWithKiller()) {
                    ...
                    foreach (PlayerControl p in CachedPlayer.AllPlayers) {
                        ...
                        if (p == Lovers.lover1 || p == Lovers.lover2)
                            ...
                            EndGameResult.CachedWinners.Add(new CachedPlayerData(p.Data));
                        else if (p != Jester.jester && p != Jackal.jackal && p != Doomsayer.doomsayer && p != Swooper.swooper && p != Werewolf.werewolf && p != Sidekick.sidekick && p != Arsonist.arsonist && p != Vulture.vulture && !Jackal.formerJackals.Contains(p) && !p.Data.Role.IsImpostor)
                            EndGameResult.CachedWinners.Add(new CachedPlayerData(p.Data));
                    }
                }
                // Lovers solo win
