    ...
    class MeetingHudPatch {
        ...
        static void guesserOnClick(int buttonTarget, MeetingHud __instance) {
            ...
            foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                ...
                else if (new List<RoleId>() { RoleId.Janitor, RoleId.Godfather, RoleId.Mafioso, RoleId.MrFreeze }.Contains(roleInfo.roleId) && CustomOptionHolder.mafiaSpawnRate.getSelection() == 0) continue;
