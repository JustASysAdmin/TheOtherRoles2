...
namespace TheOtherRoles.CustomGameModes
{
    ...
    class PropHunt
    {
        ...
        public static void clearAndReload()
        {
            ...
            isPropHuntGM = MapOptionsTor.gameMode == CustomGamemodes.PropHunt;
        ...
        public static void poolablePlayerUpdate()
        {
            ...
            {
                if (!MapOptionsTor.playerIcons.ContainsKey(pc.PlayerId)) continue;
                var poolablePlayer = MapOptionsTor.playerIcons[pc.PlayerId];
                if (pc.Data.IsDead)
                {
        ...
        {  // Make sure the map in the settings is in sync with the map from li
            if (MapOptionsTor.gameMode != CustomGamemodes.PropHunt && MapOptionsTor.gameMode != CustomGamemodes.HideNSeek || AmongUsClient.Instance.IsGameStarted) return;
