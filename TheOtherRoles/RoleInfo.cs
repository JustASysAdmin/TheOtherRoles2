...
namespace TheOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo doomsayer = new RoleInfo("Doomsayer", Doomsayer.color, "Guess People's Roles To Win!", "Win by guessing player's roles", RoleId.Doomsayer, true);
