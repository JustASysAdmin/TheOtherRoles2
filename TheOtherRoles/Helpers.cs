...
namespace TheOtherRoles {
    ...
    public static class Helpers
    {
        ...
        public static IEnumerator BlackmailShhh()
        {
            ...
            HudManager.Instance.shhhEmblem.TextImage.text = Helpers.transl("blackmailerBlackmailText");
        ...
        public static bool hasFakeTasks(this PlayerControl player) {
            return (player == Jester.jester || player == Jackal.jackal || player == Sidekick.sidekick || player == Arsonist.arsonist || player == Vulture.vulture || player == Swooper.swooper || Jackal.formerJackals.Any(x => x == player));
        }

        public static bool canBeErased(this PlayerControl player) {
            return (player != Jackal.jackal && player != Sidekick.sidekick && !Jackal.formerJackals.Any(x => x == player) && player != Swooper.swooper);
        }
    ...
    public static MurderAttemptResult checkMuderAttemptAndKill(PlayerControl killer, PlayerControl target, bool isMeetingStart = false, bool showAnimation = true)
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            ...
            //if (Assassin.isInvisble && Assassin.assassin == target) return true;
            else if(!MapOptionsTor.hidePlayerNames) return false; // All names are visible
        ...
        internal static Sprite loadSpriteFromResources(string v)
        {
