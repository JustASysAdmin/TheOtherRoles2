...
namespace TheOtherRoles
{
    ...
    public static class TheOtherRoles
    {
        ...
        public class Miner
        {
            ...
            public static void clearAndReload()
            {
                ...
                mineNumber = Mathf.RoundToInt(CustomOptionHolder.minerNumber.getFloat());
            }
        ...
        public static class Deputy
        {
            ...
            public static Sprite getHandcuffedButtonSprite()
            {
                ...
                handcuffedSprite = Helpers.loadSpriteFromResources(Helpers.transl("DeputyHandcuffedPNG"), 115f);
    ...
    public static class Tracker {
        ...
        public static float TrackerCooldown = 30f;
        ...
        public static void clearAndReload() {
            ...
            TrackerCooldown = CustomOptionHolder.trackerTrackingCooldown.getFloat();
